  ...
  <Layout>
    <div class="dg-content fr-px-2w">
      ...
      <div class="dg-cover dg-cover--linear fr-mb-4w">
        <div class="dg-cover__container fr-mb-1w">
          ...
          <p class="fr-text--lead">
            Afin de mieux connaître l’intégration du design au sein de l’État, nous effectuons un recensement des designers et designeuses travaillant en administration. Merci beaucoup pour votre participation !
          </p>
        </div>
      </div>
      ...
      <div class="dg-content dg-content--xs fr-mt-6w">
        ...
        <div class="fr-accordion fr-mb-6w">
        ...
        <form class="form" v-on:submit.prevent="addCandidate">
          ...
          <h2 class="fr-mt-6w">Votre travail</h2>
          <div class="fr-input-group">
          ...
          <div class="fr-input-group">
            <label class="fr-label" for="ministry">À quel ministère est-elle ratachée ?</label>
            <input class="fr-input" type="text" id="ministry" v-model="form.ministry" required>
          </div>
          <div class="fr-form-group">
            <fieldset class="fr-fieldset">
              <legend class="fr-fieldset__legend fr-text--regular" id='type-legend'>
                Dans quel contexte intervennez-vous auprès de cette direction ?
              </legend>
              <div class="fr-fieldset__content">
                <div class="fr-radio-group">
                  <input type="radio" id="type-1" name="type" value="Agent" v-model="form.type" required>
                  <label class="fr-label" for="type-1">Je suis un agent ou une agente publique (fonctionnaire, contractuel ou apprenti)</label>
                </div>
                <div class="fr-radio-group">
                  <input type="radio" id="type-2" name="type" value="Freelance" v-model="form.type" required>
                  <label class="fr-label" for="type-2">Je travaille en indépendant ou indépendante (freelance)</label>
                </div>
                <div class="fr-radio-group">
                  <input type="radio" id="type-3" name="type" value="Prestataire" v-model="form.type" required>
                  <label class="fr-label" for="type-3">Je suis employé(e) par un prestataire mandaté par cette direction</label>
                </div>
              </div>
            </fieldset>
          </div>
            ...
            <fieldset class="fr-fieldset">
              ...
              <div class="fr-fieldset__content">
                <div class="fr-radio-group">
                  ...
                  <label class="fr-label" for="team-1">Je suis un ou une solo designer dans mon équipe</label>
                </div>
                <div class="fr-radio-group">
                  <input type="radio" id="team-2" name="team" value="Freelance" v-model="form.team" required>
                  <label class="fr-label" for="team-2">Je fais partie d'une équipe qui comporte plusieurs designers</label>
                </div>
                <div class="fr-radio-group">
                  <input type="radio" id="team-3" name="team" value="Prestataire" v-model="form.team" required>
                  <label class="fr-label" for="team-3">Je fais partie d'une équipe dédiée au design</label>
                </div>
              </div>
            </fieldset>
          </div>

          <h2 class="fr-mt-6w">Pour aller plus loin</h2>
          <div class="fr-form-group">
            <fieldset class="fr-fieldset">
          ...
          <div class="fr-form-group">
            <fieldset class="fr-fieldset">
              <legend class="fr-fieldset__legend fr-text--regular" id='interest-legend'>
                Par ailleurs, seriez-vous intéressé par :
              </legend>
              <div class="fr-fieldset__content">
                <div class="fr-checkbox-group">
                  <input type="checkbox" id="interest-1" value="Répertoire" v-model="form.interest">
                  <label class="fr-label" for="interest-1">La création d’un répertoire (public ou interne) de designers au sein de l'Etat</label>
                </div>
                <div class="fr-checkbox-group">
                  <input type="checkbox" id="interest-2" value="Canal" v-model="form.interest">
                  <label class="fr-label" for="interest-2">La création d’un canal d’échange interne sur le sujet du design</label>
                </div>
                <div class="fr-checkbox-group">
                  <input type="checkbox" id="interest-3" value="Rencontres" v-model="form.interest">
          ...
          <div class="fr-input-group">
              <label class="fr-label" for="expectation">Qu’attenderiez-vous en particulier d'une communauté des designers au sein de l'Etat ?</label>
              <textarea class="fr-input" type="text" id="expectation" v-model="form.expectation" required></textarea>
          </div>
          <div class="fr-input-group">
              <label class="fr-label" for="more">Enfin, avez-vous une remarque, question, suggestion à nous transmettre (facultatif) ?</label>
